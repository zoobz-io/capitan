...
- [First Event System](./3.first-event-system.md) - Build a complete real-world system
- [Core Concepts](../1.learn/2.core-concepts.md) - Deep dive into signals and observers
- [Testing Guide](../3.guides/1.testing.md) - Comprehensive testing patterns
- [Event Patterns](../3.guides/2.patterns.md) - Common event coordination patterns
- [Cookbook](../4.cookbook/1.overview.md) - Copy-paste recipes for common scenarios
