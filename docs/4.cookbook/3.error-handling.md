...
- [Cascading Workflows](./4.cascading-workflows.md) - Workflow orchestration
- [Event Patterns](../3.guides/2.patterns.md) - More error handling patterns
- [Testing Guide](../3.guides/1.testing.md) - Test error scenarios
