...
Capitan provides utilities for testing event-driven code. The `testing` package offers helpers for capturing events, counting emissions, and recording panics. See [Testing Package Reference](../5.reference/3.testing.md) for complete API documentation.
...
- [Testing Package Reference](../5.reference/3.testing.md) - Complete API documentation for all testing utilities
